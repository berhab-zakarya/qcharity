        ...
        <div className="container-fluid">
          <div className="row no-gutter">
                ...
                <div className="container">
                  <div className="row">
                    <div className="col-md-12 col-lg-6 col-lg-offset-3 text-center w-full w_full">
                      <a href="/en/global/account/login" id="btn-back" className="col-xs-12 padding-none margin-50-top margin-40-bottom hidden">
                        <p className="bold">
                          <i className="fa fa-chevron-left fa-dir-flip"></i> Back
                        </p>
                      </a>
                      <div className="col-xs-12 padding-none text-center-md">
                        <p id="main-heading" className="font-24 margin-bottom-0 bold log">Log In</p>
                        <p id="sub-heading" className="margin-30-bottom font-14 margin-8-top">
                          Welcome Back, please enter your login details
                        </p>
                      </div>

                      <form action="/en/global/account/login?AV=0&amp;mobileValidation=False&amp;giftId=0" className="col-xs-12 d-flex padding-none form-horizontal text-center" id="frm-login-user" method="post" role="form" style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <div id="email-input" className="col-xs-12 padding-none form-group margin-0-bottom w-full">
                          <input 
                        ...
                        <div id="password-step" className="col-xs-12 padding-none hidden margin-0-bottom form-group w-full">
                          ...
                          <div className="col-xs-12 padding-none d-flex custom-control custom-checkbox mb-3 margin-20-top margin-0-bottom align-items-center">
                            <input className="custom-control-input pointer" id="RememberMeCheckbox" name="RememberMe" type="checkbox" value="true" />
                            <input name="RememberMe" type="hidden" value="false" />
                            <label htmlFor="RememberMeCheckbox" className="font-normal margin-bottom-0 pointer mt-[12px]">
                              Remember me?
                            </label>
                          </div>
                        </div>
                      ...
                      <div id="verification-step" className="col-xs-12 padding-none hidden otp-form">
                        ...
                        <div id="no-code-otp" className="col-xs-12 margin-30-top text-center">
                          <p>Didn't receive code?</p><br />
                          <div id="Resend" className="inline-flex text-center">
                            <button
                              type="button"
                              className="pull-right text-right padding-none red-color underline"
                              style={{ border: 0, backgroundColor: 'transparent', color: '#e00570', marginRight: 15 }}
                              id="btn-ResendCode"
                            >
                              Resend new code
                            </button>
                            <span className="padding-10-h" id="timer" style={{ fontWeight: 'bold' }}></span>
                          </div>
                        </div>
                      ...
                      <button id="sign-in" type="submit" className="col-xs-12 QC_primary-btn btn-lg margin-24-top rounded-[12px] w-full">
                        <span> Log In</span>
                      </button>
                      <button id="phone-verification" type="button" className="col-xs-12 QC_primary-btn btn-lg rounded-pill margin-24-top hidden" style={{ display: 'none' }} >
                        <span>Continue</span>
                      </button>
            ...
            <div className="col-md-7 backgroud_overlay hidden-xs hidden-sm position-relative">
              ...
              <div className="position-absolute text-white" style={{ bottom: 30 }}>
